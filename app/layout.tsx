      ...
      <head>
        <Script id="gtm-script" strategy="afterInteractive">
          {`
            ...
            })(window,document,'script','dataLayer','GTM-T9K3C8TK');
          `}
        </Script>
      </head>

      <body className="min-h-screen overflow-x-clip bg-white">
        {/* Google Tag Manager (noscript) */}
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-T9K3C8TK"
            height="0"
            width="0"
